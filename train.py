...
def get_args_parser(add_help=True):
    ...
    parser.add_argument('--resume', nargs='?', const=True, default=True, help='resume the most recent training')
    ...
    parser.add_argument('--save_ckpt_on_last_n_epoch', default=20, type=int, help='save last n epoch even not best or last, neg value not save')
