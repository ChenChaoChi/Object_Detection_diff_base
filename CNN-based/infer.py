...
def get_args_parser(add_help=True):
    ...
    parser.add_argument('--weights', type=str, default='best_ckpt.pt', help='model path(s) for inference.')
    parser.add_argument('--source', type=str, default='test2017', help='the source path, e.g. image-file/dir.')
    ...
    parser.add_argument('--yaml', type=str, default='coco.yaml', help='data yaml file.')
    parser.add_argument('--img-size', nargs='+', type=int, default=[768, 1024], help='the image-size(h,w) in inference size.')
